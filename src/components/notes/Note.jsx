...
export default function Note({ id, title, checked, pinned }) {
    ...
    return (
        ...
        <div>
            ...
            {/* note */}
            <div className={`w-full h-14 rounded-2xl flex transition-all duration-300 cursor-pointer ${taskCheck ? "shadow-sm shadow-green-500/50" : "shadow-sm shadow-white/50"}`} onClick={toggleModal}>
            ...
            <>
                {
                    noteModal && (
                        <div className="w-full h-fit mt-5 pr-3 flex items-center justify-end gap-3">

                            {/* remove */}
                            <div className="size-fit rounded-full flex items-center justify-center cursor-pointer">
                            ...
                            {/* edit */}
                            <div className="size-8 rounded-full flex items-center justify-center cursor-pointer">
                            ...
                            <div className="size-8 rounded-full flex items-center justify-center cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    className={`size-5 transition-colors duration-200
                                         ${pinned ? "text-white" : "text-white/25"
                                        }`}
                                    onClick={pinNote}>

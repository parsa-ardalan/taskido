...
export default function Routine({ name, time, icon, id }) {
    ...
    return (
        ...
        <div>
            ...
            {/* routine box */}
            <div className="w-full h-20 flex" onClick={toggleModal}>
                ...
                <div className="h-full w-1/4 flex items-center justify-center text-sm text-white/50"> {time} </div>
            </div>
                        ...
                        <div className="w-full h-fit mt-5 pr-3 flex items-center justify-end gap-3">
                            ...
                            <div className="size-8 rounded-full flex items-center justify-center cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    stroke="currentColor"
                                    id="pin-icon"
                                    className={`size-5 transition-colors duration-200 text-white/25`}
                                >
